...
const regionHandler = require('./app/handlers/region.handler');

router.get('/regiones', regionHandler.listRegion)//Para obtener cliente
router.post('/regiones', regionHandler.insertRegion)//Para insertar cliente
router.patch('/regiones/:id', regionHandler.updateRegion)// Para actualiozar cliente
router.delete('/regiones/:id', regionHandler.deleteRegion);// Para eliminar cliente
